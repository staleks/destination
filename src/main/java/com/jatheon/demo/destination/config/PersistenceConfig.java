package com.jatheon.demo.destination.config;
...
@EnableJpaRepositories(basePackages = "com.jatheon.demo.destination.repository")
public class PersistenceConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        emf.setPackagesToScan("com.jatheon.demo.destination.model");
